...
public class OrderItemsDAOImpl implements OrderItemsDAO {
    ...
    public void updateOrder(OrderItems orderItem) throws SQLException {
        ...
        try (Connection conn = connect(); 
            ...
            stmt.setInt(4, orderItem.getItemtotal());
    ...
    public List<OrderItems> getOrdersByRestaurantId(int restaurantId) throws SQLException {
        ...
        String query = "SELECT oi.orderitemid, oi.OrderId, oi.menuid, oi.quantity, oi.itemtotal " +
                       "FROM orderitems oi " +
                       "JOIN orders o ON oi.OrderId = o.orderId " + // Assuming there's an orders table
                       "WHERE o.resturantid = ?"; // Adjust the column name as necessary
